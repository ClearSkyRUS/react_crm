...
const FieldsTypesSwitch = ({ type, field, object, newObject, setNewObject }) => {
    ...
    switch (type) {
        ...
        case 'Number':
        case 'Date':
            return <Simple value={value} setValue={setValue} field={field} type={type} />
        case 'Boolean':
            return <Boolean checked={value} setValue={setValue} field={field} />
        case 'ObjectId':
            return <ObjectId multi={false} modelName={object.ref} value={value} setValue={setValue} field={field} />
        case 'Array':
            return <Array type={type} field={field} newObject={value} setNewObject={setValue} object={object} />
        case 'Object':
            return <Object type={type} field={field} newObject={value} setNewObject={setValue} />
        default:
            return (
                <Form.Field >
