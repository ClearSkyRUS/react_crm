    ...
    return (
        <div className='pageHeader'>
            <Header as='h5' dividing className='pageHeader-header'>
                ...
                <Input value={pageState.params.search ? pageState.params.search : ''} onChange={(e, { value }) => setSearch(value)} className='pageHeader-header__search' icon='search' size='mini' placeholder='Search...' />
            </Header>
        </div>
    )
}